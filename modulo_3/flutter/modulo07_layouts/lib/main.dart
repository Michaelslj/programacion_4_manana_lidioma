    ...
    4 => const Scaffold(
      body: Center(
        child: Row(
          ...
          children: [
            AvatarBadge(nombre: 'web-01', alertas: 2,  activo: true, message: 'Servidor web principal'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'db-01',  alertas: 0,  activo: true, message: 'Base de datos principal'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'worker', alertas: 0,  activo: false, message: 'Worker de procesamiento de colas'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'cache',  alertas: 11, activo: true, message: 'Servidor de cache Redis'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'Servidor DHCP',  alertas: 11, activo: true, message: 'Servidor DHCP'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'Detalle: 10.4.3.2ms',  alertas: 11, activo: false, message: 'Detalle del servidor'),
            SizedBox(width: 24),
            AvatarBadge(nombre: 'cache',  alertas: 11, activo: true, message: 'Servidor de cache Redis'),
          ],
        ),
