...
class _Paso3State extends State<_Paso3> {
  final _servidores = [
    ...
    ServidorSSH(id:'2', nombre:'prod-db-01',   ip:'10.0.2.20',   puerto:22,   usuario:'postgres', so:'Debian 12',    ssl:true, servicio:'database'),
    ServidorSSH(id:'3', nombre:'staging-api',  ip:'10.0.3.10',   puerto:2222, usuario:'ubuntu',   so:'Ubuntu 24.04', ssl:false, servicio:'api'),
    ServidorSSH(id:'4', nombre:'dev-sandbox',  ip:'192.168.1.5', puerto:22,   usuario:'vagrant',  so:'Alpine Linux', ssl:false, servicio:'development'),
    ServidorSSH(id: '5', nombre: 'desarrollo', ip: '192.168.1.100', puerto: 22, usuario: 'developer', so: 'Fedora 39', ssl: true, servicio: 'web')
  ];
