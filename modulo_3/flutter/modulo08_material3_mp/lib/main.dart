...
void main() => runApp(const AppInventario());

class AppInventario extends StatefulWidget {
  const AppInventario({super.key});
  @override
  State<AppInventario> createState() => _AppInventarioState();
}

class _AppInventarioState extends State<AppInventario> {
