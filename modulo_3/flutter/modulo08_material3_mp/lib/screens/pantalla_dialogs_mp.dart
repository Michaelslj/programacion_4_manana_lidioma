...
class PantallaDialogs extends StatelessWidget {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(esError
            ...
            : 'Producto sincronizado correctamente con el inventario'),
  ...
  Future<void> _mostrarConfirmacion(BuildContext context) async {
    final confirmar = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          '¿Estás seguro de que deseas eliminar Audífonos inalámbricos A101?\n'
  ...
  Future<void> _mostrarFormulario(BuildContext context) async {
    ...
    final ctrlUbicacion = TextEditingController();
            ...
            children: [
              ...
              TextFormField(
                ...
                validator:  (v) {
                  ...
                  if (partes.length != 4) return 'Formato: pasillo.estante.nivel.posición';
                  return null;
                },
              ),
            ],
    ...
    if (ctrlNombre.text.isNotEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Producto "${ctrlNombre.text}" agregado')),
      );
    }
  }
      ...
      body: ListView(
        ...
        children: [
          ...
          FilledButton.icon(
            onPressed: () => _mostrarSnackBar(context),
            icon:  const Icon(Icons.check_circle_outline),
            label: const Text('SnackBar de cancelación'),
          ),
          ...
          FilledButton.tonal(
            ...
            child: const Text('Cancelar producto (formulario)'),
          ),
          const SizedBox(height: 8),
          FilledButton.tonal(
            onPressed: () => _mostrarFormulario(context),
