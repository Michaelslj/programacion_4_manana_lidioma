...
import 'package:modulo12_api/pantalla_paso3_users.dart';
import 'package:modulo12_api/todo_dto_users.dart';
  ...
  Widget build(BuildContext context) {
    const pasos = [
      ...
      _PasoInfo(
        ruta: '/paso1-users',
        titulo: 'Paso 1-Users',
        subtitulo: 'FutureBuilder crudo - Users',
        detalle: 'http.get() + FutureBuilder · JSONPlaceholder - Users',
        icono: Icons.network_ping,
      ...
      _PasoInfo(
        ...
        detalle: 'TodoDtoUser.fromJson · lista de usuarios',
        icono: Icons.data_object,
        color: Colors.green,
      ),
      _PasoInfo(
