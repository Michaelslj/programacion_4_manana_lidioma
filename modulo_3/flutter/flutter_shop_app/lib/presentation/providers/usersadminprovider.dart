...
class UsersAdminNotifier extends StateNotifier<UsersAdminState> {
  ...
  Future<void> load({bool reset = true}) async {
    ...
    final bool? isStaff;
    final bool? isActive;
    switch (currentState.roleFilter) {
      case UserRoleFilter.clients:
        isStaff = false;
        isActive = null;
        break;
      case UserRoleFilter.staff:
        ...
        isActive = null;
        break;
      case UserRoleFilter.active:
        isStaff = null;
        isActive = true;
        break;
      case UserRoleFilter.inactive:
        isStaff = null;
        isActive = false;
        break;
      default:
    ...
    try {
      ...
      state = state.copyWith(
        users:      reset ? result.results : [...currentState.users, ...result.results],
        total:      result.count,
