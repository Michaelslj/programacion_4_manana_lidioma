...
import 'package:modulo12_api_mp/pantalla_paso3_users.dart';
...
final _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/paso3-users', builder: (_, __) => const PantallaPaso3Users()),
    // Paso 2 → reemplaza por PantallaPaso2()
    GoRoute(path: '/paso2', builder: (_, __) => const PantallaPaso2()),
    // Paso 3 → API real de Platzi + modelo de dominio
  ...
  Widget build(BuildContext context) {
    const pasos = [
      _PasoInfo(
        ...
        detalle: 'http.get() + FutureBuilder · JSONPlaceholder /todos',
        icono: Icons.network_ping,
        color: Colors.blue,
      ),
      _PasoInfo(
        ruta: '/paso1-users',
        titulo: 'Paso 1-Proveedores',
        subtitulo: 'FutureBuilder crudo - Proveedores',
        detalle: 'http.get() + FutureBuilder · JSONPlaceholder /users (proveedores)',
        icono: Icons.network_ping,
      ...
      _PasoInfo(
        ...
        detalle: 'TareaInventarioDto.fromJson · lista de tareas de inventario',
        icono: Icons.data_object,
        color: Colors.green,
      ),
      _PasoInfo(
        ruta: '/paso3-users',
        titulo: 'Paso 3-Proveedores',
        subtitulo: 'DTO simple - Proveedores',
        detalle: 'ProveedorDto.fromJson · lista de proveedores',
        icono: Icons.data_object,
        color: Colors.green,
      ),
      _PasoInfo(
