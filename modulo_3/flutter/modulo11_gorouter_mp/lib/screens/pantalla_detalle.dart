...
class PantallaDetalle extends StatelessWidget {
  final String    id;
  final Producto? producto; // puede venir por extras
          ...
          : Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _Fila('Ubicación', prod.ubicacion),
                  _Fila('Cantidad',  prod.cantidad.toString()),
                  _Fila('Promoción', prod.enPromocion ? 'Activa' : 'Inactiva'),
                  ...
                  Row(children: [
                    ...
                    FilledButton.icon(
                      onPressed: () => context.push('/productos/${prod.id}/logs'),
